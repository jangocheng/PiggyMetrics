...
//start for class AbstractStatisticsService
public abstract class StatisticsServiceBase : IServiceActor<AmpMessage> 
{
...
{
//方法StatisticsService.UpdateStatistics
if(req.MessageId == 1){return this.ReceiveUpdateStatisticsAsync(context, req);}
//方法StatisticsService.FindByAccount
if(req.MessageId == 1){return this.ReceiveFindByAccountAsync(context, req);}
return Task.CompletedTask;
}
}
//end for class AbstractStatisticsService
